...
{
    public class BindableSelectedItemBehavior2 : Behavior<TreeView>
    {
        ...
        public static readonly DependencyProperty SelectedItemProperty =
            DependencyProperty.Register(
                "SelectedItem",
                typeof(object),
                typeof(BindableSelectedItemBehavior2),
        ...
        private static void OnSelectedItemChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (tvi == null)
            {
                var tree = ((BindableSelectedItemBehavior2)sender).AssociatedObject;
                //tree.SetValue(VirtualizingPanel.IsVirtualizingProperty, false);
                if (!tree.IsLoaded)
                {
...
#pragma warning restore 168
                ...
                for (int i = 0, count = container.Items.Count; i < count; i++)
                {
                    ...
                    //TreeViewHelper.BringIntoView(subContainer, i);
